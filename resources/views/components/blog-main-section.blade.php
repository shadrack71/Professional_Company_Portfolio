            ...
            <div class="row gy-4 posts-list">
                ...
                <div class="col-xl-4 col-md-6">
                    <article>
                        ...
                        <h2 class="title">
                            <a href="{{route('single-blog')}}">Dolorum optio tempore voluptas dignissimos</a>
                        </h2>
                ...
                <div class="col-xl-4 col-md-6">
                    <article>
                        ...
                        <h2 class="title">
                            <a href="{{route('single-blog')}}">Nisi magni odit consequatur autem nulla dolorem</a>
                        </h2>
                ...
                <div class="col-xl-4 col-md-6">
                    <article>
                        ...
                        <h2 class="title">
                            <a href="{{route('single-blog')}}">Possimus soluta ut id suscipit ea ut in quo quia et
                                soluta</a>
                        </h2>
                ...
                <div class="col-xl-4 col-md-6">
                    <article>
                        ...
                        <h2 class="title">
                            <a href="{{route('single-blog')}}">Non rem rerum nam cum quo minus olor distincti</a>
                        </h2>
                ...
                <div class="col-xl-4 col-md-6">
                    <article>
                        ...
                        <h2 class="title">
                            <a href="{{route('single-blog')}}">Accusamus quaerat aliquam qui debitis facilis
                                consequatur</a>
                        </h2>
                ...
                <div class="col-xl-4 col-md-6">
                    <article>
                        ...
                        <h2 class="title">
                            <a href="{{route('single-blog')}}">Distinctio provident quibusdam numquam aperiam aut</a>
                        </h2>
